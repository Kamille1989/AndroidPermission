...
//	        }
    ...
    public static ArrayList<String> getNoGrantedPermission(Activity activity, boolean isShouldRationale) {
        ...
        for (int i = 0; i < requestPermissions.length; i++) {
            ...
            if (checkSelfPermission != PackageManager.PERMISSION_GRANTED) {
            	boolean flag = ActivityCompat.shouldShowRequestPermissionRationale(activity, requestPermission);
                Log.d(TAG, "getNoGrantedPermission" + requestPermission + ":" + checkSelfPermission + ":" + flag);
                if (flag) {
	...
	public static boolean CheckPermissions(Activity activity) {
		final List<String> permissionsList = getNoGrantedPermission(activity, false);
        final List<String> shouldRationalePermissionsList = getNoGrantedPermission(activity, true);
        return permissionsList.size() == 0 && shouldRationalePermissionsList.size() == 0;
	}
}
